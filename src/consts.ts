...
export const SITE_NAME = "Kigudev";
/** Fallback meta description for pages that don't set their own. */
export const SITE_DESCRIPTION =
  "Kigudev designs and builds thoughtful digital products with clarity, usability, and performance at their core.";
/** Canonical origin. Resolves canonical URLs, social images, and the sitemap. */
export const SITE_URL = "https://kigudev.com";
